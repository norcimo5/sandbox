...
**
** Created: Thu Dec 13 10:09:04 2012
...
static const char qt_meta_stringdata_FindDialog[] = {
    "FindDialog\0\0str,cs\0findNext(QString,Qt::CaseSensitivity)\0"
    "findPrevious(QString,Qt::CaseSensitivity)\0"
    "joemama(QString,Qt::CaseSensitivity)\0findClicked()\0text\0"
...
int FindDialog::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: joemama((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< Qt::CaseSensitivity(*)>(_a[2]))); break;
        case 3: findClicked(); break;
        case 4: enableFindButton((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        }
        _id -= 5;
    }
    return _id;
...
// SIGNAL 2
void FindDialog::joemama(const QString & _t1, Qt::CaseSensitivity _t2)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
