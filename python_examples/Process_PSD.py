...
def Process_PSD_Stream(inFile, plt):
    ...
    try:
        ...
        while in_buf != "":
            ...
            msg_seq_num = data_response.msg_seq_num
            #print "msg_seq_num: %d" % msg_seq_num
...
def print_PSD_Stats(data_np, header, format, print_header, data_rate_Mbps, sweeps_per_sec):
    ...
    if print_header and not header.group_id % 5:
        ...
        print "%s Group     Data    Bits/          Scaling                  Start      End   Incr   Sig   Sig   Sig  DataRate  Sweeps/ %s" % (WHITE, RESET)
