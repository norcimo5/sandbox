  ...
  namespace Internal {
    ...
    struct Closure {
        ...
        inline void bind(TThis* mThis, TFunc mFunc) noexcept {
          ptrThis = SimplifyMemFunc<sizeof(mFunc)>::convert(mThis, mFunc,
          ptrFunction);
        }
      
      template<class TThis, class TInvoker>
      inline void bind(TThis* mThis,
        TInvoker mInvoker, PtrStaticFuncT mFunc) noexcept
        {
          if (mFunc == nullptr)
            ptrFunction = nullptr;
          else
    ...
    class FastFuncImpl {
      ...
      protected:
        template<class TThis, class TFunc> inline void bind(TThis* mThis,
            TFunc mFunc) noexcept {
          closure.bind(mThis, mFunc);
        }
        template<class TFunc> inline void bind(TFunc mFunc) noexcept {
      ...
      public:
        ...
        template<typename X, typename Y> inline FastFuncImpl(X* mThis, Y mFunc)
            noexcept {
          bind(mThis, mFunc);
        }
